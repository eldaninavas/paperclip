 ...
 * interstitial into its status line; the Foundation Runner task surface instead
...
/**
 * Semantic rows for the Foundation runner's Codex-style activity disclosure.
 *
...
/**
 * Ordered input for the Foundation Runner task-turn timeline. This keeps the
...
/**
 * Resolve the durable response owned by a Foundation Runner turn. Provider final
        ...
        case "paperclip_read":
          text =
            count === 1
              ...
              : `Read from Foundation ${count} times`;
          break;
        case "task_operation":
          text =
            count === 1 ? "Used Foundation" : `Used Foundation ${count} times`;
          break;
        default:

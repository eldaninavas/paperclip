...
import { Bot, FileText, Hexagon, MessageSquare, Paperclip as Foundation, Quote } from "lucide-react";
...
const SNIPPET_STYLES: Record<string, SnippetStyle> = {
  ...
  artifact: { Icon: Foundation, label: "Artifact" },
...
function SearchResultRowImpl({
  ...
  if (result.type === "artifact") {
    ...
    return (
      ...
      >
        <Foundation className="mt-1 h-4 w-4 shrink-0 text-muted-foreground" />
        <div className="min-w-0 flex-1">

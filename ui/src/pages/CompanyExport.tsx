...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is a Foundation agent-company package.");
  lines.push("");
  ...
  lines.push("");
  lines.push("Import this package from Foundation to restore the company.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from Foundation on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");

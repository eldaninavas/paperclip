  ...
  return (
    <div className="mt-6 border-t border-border pt-5">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        {hasActiveInvite
          ? "A bootstrap invite is already active. Check your Foundation startup logs for the first‑admin URL, or run this command on the host to rotate it:"
          : "Run this command on the host that runs Foundation to print a one‑time first‑admin invite URL:"}
      </p>
...
function SignedOutPrivate() {
  return (
    <StateChrome>
      <h1 className="text-xl font-semibold">Finish setting up this Foundation</h1>
      <p className="mt-2 text-sm text-muted-foreground">
        No admin has claimed this instance yet. Sign in or create your Foundation account to become the first

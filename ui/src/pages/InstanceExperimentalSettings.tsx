...
export function InstanceExperimentalSettings() {
  ...
  // render locked with the "Managed by Foundation Cloud" badge. Self-hosted
    ...
    <div className="max-w-6xl space-y-6">
      ...
      <section className="space-y-3" aria-labelledby="experimental-features-heading">
        ...
        <ExperimentalToggleCard
          title="Beta skills"
          description="Allow agents to pin beta releases of the Foundation core skill. Disabling this returns every agent to the default live skill without removing saved pins."
        ...
        <ExperimentalToggleCard
          ...
          description="Show Foundation-managed built-in agent surfaces, including built-in roster badges, the Built-in agents tab, and built-in agent setup controls."
        ...
        <ExperimentalToggleCard
          ...
          description="Allow new Codex agents to select the experimental Rust Foundation Runner, including authenticated runner ingress when a sandbox requires it. Onboarding continues to use legacy adapters. Turning this off hides the choice without affecting existing native runs."
          ...
          ariaLabel="Toggle Foundation Runner experimental setting"
        />
      ...
      <section className="space-y-3" aria-labelledby="developer-mode-heading">
        <div className="space-y-1">
          <h2 id="developer-mode-heading" className="text-sm font-semibold">
            Foundation Developer Mode
          </h2>
          <p className="text-sm text-muted-foreground">
            Internal tools for developing, testing, and debugging Foundation.
          </p>
        </div>

        <ExperimentalToggleCard
          title="Foundation Developer Mode"
          description="Show internal Foundation maintainer tools and observability links, including Honeycomb trace queries on run pages."
          ...
          ariaLabel="Toggle Foundation developer mode experimental setting"
        />

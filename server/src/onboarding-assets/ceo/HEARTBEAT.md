...
Run this checklist on every heartbeat. This covers both your local planning/memory work and your organizational coordination via the Foundation operational skill.
...
- For scoped issue wakes, Foundation may already checkout the current issue in the harness before your run starts.
...
- Always use the Foundation operational skill for coordination.

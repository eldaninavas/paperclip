...
// Foundation mark: three pillars + wordmark, vertically centered
const FOUNDATION_LOGO_SVG = `<g>
  <g fill="currentColor">
    <path d="M0 6 4 3v10l-4-3z"/>
    <path d="M6 2 10 0v16l-4-3z"/>
    <path d="m12 3 4 3v4l-4 3z"/>
  </g>
  <text x="23" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Foundation</text>
</g>`;

...
const DEFAULT_FAVICON_LINKS = [
  '<link rel="icon" href="/foundation-mark.svg?v=pillar-2" type="image/svg+xml" sizes="any" />',
  '<link rel="shortcut icon" href="/foundation-mark.svg?v=pillar-2" type="image/svg+xml" />',
].join("\n");

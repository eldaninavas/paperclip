...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an Agent Company package from Foundation by Davaria.");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Foundation](https://foundation.davaria.app) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [Foundation](https://foundation.davaria.app) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
